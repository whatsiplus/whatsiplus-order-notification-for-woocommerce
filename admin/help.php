...
class WhatsiPLUS_Help_View implements Whatsiplus_Register_Interface {
    ...
    ?>
        ...
        <h1><?php esc_html_e('Want to see supported shortcodes and create your own WhatsApp message templates?', 'whatsiplus-order-notification-for-woocommerce'); ?></h1>
        <h2><?php esc_html_e('You can use our visual WhatsApp Text Formatter tool to easily build messages and test shortcode output.', 'whatsiplus-order-notification-for-woocommerce'); ?>
            <a href="<?php echo esc_url( __('https://whatsiplus.com/upload/wordpress/whatsapp-text-formatter/', 'whatsiplus-order-notification-for-woocommerce') ); ?>" target="_blank">
                <strong><?php esc_html_e('Open Formatter Tool', 'whatsiplus-order-notification-for-woocommerce'); ?></strong>
            </a>
        </h2>
