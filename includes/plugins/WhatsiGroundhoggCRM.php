    ...
    */
    ...
    public function get_setting_section_data()
    {
        return array(
            ...
            'title' => __( 'Groundhogg CRM', 'whatsiplus-order-notification-for-woocommerce' ),
        );
    }
    ...
    private function get_send_on_fields() {
        return array(
            ...
            'desc'    => __( 'Choose when to send a notification message', 'whatsiplus-order-notification-for-woocommerce' ),
            'type'    => 'multicheck',
            'options' => array(
                'confirmed'    => 'Confirmed',
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Confirmed status message', 'whatsiplus-order-notification-for-woocommerce' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], thank you for subscribing, trending contents will be delivered to you.', 'whatsiplus-order-notification-for-woocommerce' )
            ),
            array(
                'name'    => 'whatsiplus_automation_sms_template_unconfirmed',
                'label'   => __( 'Unconfirmed status message', 'whatsiplus-order-notification-for-woocommerce' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], would you like to opt-in to our newsletter and get trending contents delivered to you ? We promise we will not spam you.', 'whatsiplus-order-notification-for-woocommerce' )
            ),
            array(
                'name'    => 'whatsiplus_automation_sms_template_unsubscribed',
                'label'   => __( 'Unsubscribed status message', 'whatsiplus-order-notification-for-woocommerce' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], we are sorry to see you go, tell us how cna we improve to serve you better in the future ?', 'whatsiplus-order-notification-for-woocommerce' )
            ),
        );
    }
