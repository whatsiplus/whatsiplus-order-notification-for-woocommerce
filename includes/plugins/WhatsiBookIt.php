    ...
    */
    ...
    public function get_setting_section_data()
    {
        return array(
            ...
            'title' => __( 'BookIt', 'whatsiplus-order-notification-for-woocommerce' ),
        );
    }
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Appointment pending message', 'whatsiplus-order-notification-for-woocommerce' ),
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [customer_name], your appointment for [service_name] on [appointment_day] is [appointment_status]', 'whatsiplus-order-notification-for-woocommerce' )
            ),
            array(
                'name'    => 'whatsiplus_automation_sms_template_appointment_approved',
                'label'   => __( 'Appointment approved message', 'whatsiplus-order-notification-for-woocommerce' ),
            ...
            array(
                ...
                'label'   => __( 'Appointment cancelled message', 'whatsiplus-order-notification-for-woocommerce' ),
    ...
    private function get_reminder_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Send reminder to customer reservation', 'whatsiplus-order-notification-for-woocommerce' ),
    ...
    private function get_sms_reminder_template_fields() {
        return array(
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Greetings [customer_name], your appointment for [service_name] on [appointment_day] is [appointment_status]. - custom', 'whatsiplus-order-notification-for-woocommerce' )
            ),
        );
    }
