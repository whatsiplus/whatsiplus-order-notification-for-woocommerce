    ...
    */
    ...
    public function get_setting_section_data()
    {
        return array(
            ...
            'title' => __( 'Fluent CRM', 'whatsiplus-order-notification-for-woocommerce' ),
        );
    }
    ...
    private function get_sms_template_fields() {
        return array(
            array(
                ...
                'label'   => __( 'Subscribed status message', 'whatsiplus-order-notification-for-woocommerce' ),
            ...
            array(
                ...
                'cols'    => '500',
                'css'     => 'min-width:350px;',
                'default' => __( 'Hi [first_name], you have unsubscribed and will no longer receive trending contents.', 'whatsiplus-order-notification-for-woocommerce' )
            ),
            array(
                'name'    => 'whatsiplus_automation_sms_template_pending',
                'label'   => __( 'Pending status message', 'whatsiplus-order-notification-for-woocommerce' ),
