...
class Whatsiplus_Multivendor_Setting implements Whatsiplus_Register_Interface {
	...
	public function set_multivendor_setting_section( $sections ) {
		$sections[] = array(
			...
			'title' => __( 'Multivendor Settings', 'whatsiplus-order-notification-for-woocommerce' ),
	...
	public function set_multivendor_setting_field( $setting_fields ) {
		...
		$setting_fields['whatsiplus_multivendor_setting'] = array(
			array(
				...
				'label'   => __( 'Enable Vendor WhatsApp Notifications', 'whatsiplus-order-notification-for-woocommerce' ),
				'desc'    => 'Enable',
				'type'    => 'checkbox',
				'default' => 'off',
			),
			array(
				...
				'desc'    => __( 'Choose when to send a status notification message to your vendors', 'whatsiplus-order-notification-for-woocommerce' ),
				'type'    => 'multicheck',
				'default' => array(
			...
			array(
				...
				'label'   => __( 'Third Party Plugin', 'whatsiplus-order-notification-for-woocommerce' ),
